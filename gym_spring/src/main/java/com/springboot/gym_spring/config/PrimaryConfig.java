package com.springboot.gym_spring.config;
...
@EnableJpaRepositories(
        ...
        basePackages = {"com.springboot.gym_spring.datasource1.repository"})
public class PrimaryConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryPrimary(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("com.springboot.gym_spring.datasource1.domain")
